...
const demos: { name: string; desc: string; supports: string }[] = [
  ...
  { name: 'notifications', desc: '推送通知', supports: 'Android (device only), iOS (device only)' },
  ...
  // { name: 'route', desc: '路由器', supports: 'Android, iOS, Web' },
  // { name: 'route-ui', desc: '路由 UI', supports: 'Android, iOS, Web' },
  ...
  // { name: 'screens', desc: '屏幕', supports: 'Android, iOS, Web' },
  // { name: 'securestore', desc: '在设备上加密和本地安全存储键值对', supports: 'Android, iOS' },
