...
export default function ExpoUpdatesScreen() {
  ...
  return (
    <View className="flex-1 p-5">
      ...
      {/* 当前版本信息 */}
      <View className="mb-6">
        <Text className="font-medium mb-2">当前版本信息</Text>
        <View className="bg-muted rounded-lg p-4 gap-2">
          <Text>更新渠道: {Updates.channel || 'unknown'}</Text>
      ...
      {/* 检查更新 */}
      <View className="mb-6">
        <Text className="font-medium mb-2">检查更新</Text>
      ...
      {updateInfo && (
        <View className="mb-6">
          <Text className="font-medium mb-2">更新信息</Text>
          <View className="bg-muted rounded-lg p-4 gap-2">
      ...
      {updateInfo?.isAvailable && !isDownloaded && (
        <View className="mb-6">
          <Text className="font-medium mb-2">下载更新</Text>
      ...
      {isDownloaded && (
        <View className="mb-6">
          <Text className="font-medium mb-2">应用更新</Text>
