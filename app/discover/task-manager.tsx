  ...
  return (
    <ScrollView className="flex-1 p-6">
      <View className="mb-6">
        ...
        <Text className="text-gray-600 mb-4">此功能用于在后台持续获取位置信息。</Text>
      </View>
      ...
      <View className="mb-8">
        ...
        <View className="bg-gray-100 rounded-lg p-4">
          <Text className="text-gray-600 mb-2">任务管理器可用: {isTaskAvailable ? '是' : '否'}</Text>
          <Text className="text-gray-600 mb-2">位置任务已注册: {isTaskRegistered ? '是' : '否'}</Text>
          <Text className="text-gray-600 mb-2">位置权限: {locationPermission || '未请求'}</Text>
        </View>
      </View>
